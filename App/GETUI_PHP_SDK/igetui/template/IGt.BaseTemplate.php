<?php
namespace App\GETUI_PHP_SDK\igetui\template;
...
require_once(dirname(__FILE__) . '/' . './notify/SmsMessage.php');
use App\GETUI_PHP_SDK\igetui\Transparent;
use App\GETUI_PHP_SDK\igetui\SmsInfo;
use App\GETUI_PHP_SDK\igetui\PushInfo;
use App\GETUI_PHP_SDK\igetui\SmsContentEntry;
use App\GETUI_PHP_SDK\igetui\IGtAPNPayload;
use App\GETUI_PHP_SDK\igetui\DictionaryAlertMsg;
//use App\GETUI_PHP_SDK\igetui\template\IGtNotificationTemplate;
