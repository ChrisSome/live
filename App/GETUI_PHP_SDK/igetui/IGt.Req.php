<?php
namespace App\GETUI_PHP_SDK\igetui;

use App\GETUI_PHP_SDK\protobuf\type\PBEnum;
...
namespace App\GETUI_PHP_SDK\igetui;
use App\GETUI_PHP_SDK\protobuf\PBMessage;
...
namespace App\GETUI_PHP_SDK\igetui;
use App\GETUI_PHP_SDK\protobuf\type\PBEnum as GRPBEnum;

class GtAuthResult_GtAuthResultCode extends GRPBEnum
{
    const successed  = 0;
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as GPBMessage;
class GtAuthResult extends GPBMessage
{
    var $wired_type = GPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBInt";
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as RSPBMessage;

class ReqServList extends RSPBMessage
{
    var $wired_type = RSPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
...
use App\GETUI_PHP_SDK\protobuf\type\PBEnum as RPBEnum;

class ReqServListResult_ReqServHostResultCode extends RPBEnum
{
    const successed  = 0;
    const failed  = 1;
    const busy  = 2;
}
use App\GETUI_PHP_SDK\protobuf\PBMessage as RPBMessage;
class ReqServListResult extends RPBMessage
{
    var $wired_type = RPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBInt";
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as TPBMessage;

class Target extends TPBMessage
{
    var $wired_type = TPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
...
use App\GETUI_PHP_SDK\protobuf\type\PBEnum as PPBEnum;

class PushResult_EPushResult extends PPBEnum
{
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as PPBMessage;

class PushResult extends PPBMessage
{
    var $wired_type = PPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as PLPBMessage;

class PushListResult extends PLPBMessage
{
    var $wired_type = PLPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as EPBMessage;

class ExtKV extends EPBMessage
{
    var $wired_type = EPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
...
use App\GETUI_PHP_SDK\protobuf\type\PBEnum as NPBEnum;
class NotifyInfo_Type extends NPBEnum
{
    const _payload  = 0;
    const _intent  = 1;
    const _url  = 2;
}
use App\GETUI_PHP_SDK\protobuf\PBMessage as NPBMessage;
class NotifyInfo extends NPBMessage
{
    var $wired_type = NPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
    ...
    function set_extKV($index, $value)
    {
        $this->_set_arr_value("8", $index, $value);
    }
    function remove_last_extKV()
    {
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as PIPBMessage;
class PushInfo extends PIPBMessage
{
    var $wired_type = PIPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
    ...
    function blackThirdparty($offset)
    {
        $v = $this->_get_arr_value("17", $offset);
        return $v->get_value();
    }
    function append_blackThirdparty($value)
    {
        $v = $this->_add_arr_value("17");
        $v->set_value($value);
    }
    function set_blackThirdparty($index, $value)
    {
        $v = new $this->fields["17"]();
        $v->set_value($value);
        $this->_set_arr_value("17", $index, $v);
    }
    function remove_last_blackThirdparty()
    {
        $this->_remove_last_arr_value("17");
    }
    function blackThirdparty_size()
    {
        return $this->_get_arr_size("17");
    }
}
use App\GETUI_PHP_SDK\protobuf\PBMessage as BPBMessage;
class Button extends BPBMessage
{
    var $wired_type = BPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as APBMessage;
class AppStartUp extends APBMessage
{
    var $wired_type = APBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
...
use App\GETUI_PHP_SDK\protobuf\type\PBEnum as SPBEnum;
class SMSStatus extends SPBEnum
{
    const unread  = 0;
    const read  = 1;
}
use App\GETUI_PHP_SDK\protobuf\type\PBEnum as IPBEnum;

class InnerFiled_Type extends IPBEnum
{
    const str  = 0;
    const int32  = 1;
    const int64  = 2;
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as IPBMessage;
class InnerFiled extends IPBMessage
{
    var $wired_type = IPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
...
use App\GETUI_PHP_SDK\protobuf\type\PBEnum as APBEnum;
class ActionChain_Type extends APBEnum
{
    const refer  = 0;
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as ACPBMessage;
use App\GETUI_PHP_SDK\protobuf\type\PBBool as APBBool;
class ActionChain extends ACPBMessage
{
    var $wired_type = ACPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBInt";
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as SPBMessage;
class SmsContentEntry extends SPBMessage
{
    var $wired_type = SPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as SIPBMessage;
class SmsInfo extends SIPBMessage
{
    var $wired_type = SIPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as TSPBMessage;
class Transparent extends TSPBMessage
{
    var $wired_type = TSPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as OPBMessage;
class OSMessage extends OPBMessage
{
    var $wired_type = OPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as POPBMessage;
class PushOSSingleMessage extends POPBMessage
{
    var $wired_type = POPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as MPBMessage;
use App\GETUI_PHP_SDK\protobuf\type\PBBool;
class MMPMessage extends MPBMessage
{
    var $wired_type = MPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as PMPBMessage;
class PushMMPSingleMessage extends PMPBMessage
{
    var $wired_type = PMPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as PSPBMessage;
class PushMMPSingleBatchMessage extends PSPBMessage
{
    var $wired_type = PSPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as SMPBMessage;

class StartMMPBatchTask extends SMPBMessage
{
    var $wired_type = SMPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as SOMPBMessage;

class StartOSBatchTask extends SOMPBMessage
{
    var $wired_type = SOMPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as SBPBMessage;

class SingleBatchItem extends SBPBMessage
{
    var $wired_type = SBPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBInt";
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as SBRPBMessage;

class SingleBatchRequest extends SBRPBMessage
{
    var $wired_type = SBRPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as PLMPBMessage;
class PushListMessage extends PLMPBMessage
{
    var $wired_type = PLMPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as EBPBMessage;
class EndBatchTask extends EBPBMessage
{
    var $wired_type = EBPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as SBTPBMessage;

class StopBatchTask extends SBTPBMessage
{
    var $wired_type = SBTPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as SBTRPBMessage;

class StopBatchTaskResult extends SBTRPBMessage
{
    var $wired_type = SBTRPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as PMAPBMessage;

class PushMMPAppMessage extends PMAPBMessage
{
    var $wired_type = PMAPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "MMPMessage";
...
use App\GETUI_PHP_SDK\protobuf\type\PBEnum as SNPBEnum;

class ServerNotify_NotifyType extends SNPBEnum
{
    const normal  = 0;
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as SNOPBMessage;
class ServerNotify extends SNOPBMessage
{
    var $wired_type = SNOPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
...
use App\GETUI_PHP_SDK\protobuf\PBMessage as SNRPBMessage;

class ServerNotifyResult extends SNRPBMessage
{
    var $wired_type = SNRPBMessage::WIRED_LENGTH_DELIMITED;
    public function __construct($reader=null)
    {
        parent::__construct($reader);
        $this->fields["1"] = "PBString";
