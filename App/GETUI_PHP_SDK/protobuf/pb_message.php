<?php
namespace App\GETUI_PHP_SDK\protobuf;
 ...
 * @author Nikolai Kordulla
 */
use App\GETUI_PHP_SDK\protobuf\encoding\base128varint;
use App\GETUI_PHP_SDK\protobuf\type\PBInt;
use App\GETUI_PHP_SDK\protobuf\type\PBString;
use App\GETUI_PHP_SDK\protobuf\reader\PBInputStringReader;
use App\GETUI_PHP_SDK\igetui\PushInfo;
use App\GETUI_PHP_SDK\igetui\ActionChain;
use App\GETUI_PHP_SDK\igetui\SmsInfo;
abstract class PBMessage
{
    ...
    private function _ParseFromArray($length=99999999)
    {
        ...
        while ($this->reader->get_pointer() - $_begin < $length)
        {
            ...
            if (!isset($this->fields[$messtypes['field']]))
            {
                ...
                {
                    file_put_contents('./log.log', $this->reader);
    ...
    protected function _add_arr_value($index)
    {
        switch ($index){
            ...
            case 9:
            case 11:
                return $this->values[$index][] = new PBString();
                break;
            case 7:
                return $this->values[$index][] = new PushInfo();
                break;
            case 8:
                return $this->values[$index][] = new ActionChain();
                break;
            case 10:
                return $this->values[$index][] = new PBInt();
                break;
            case 12:
                return $this->values[$index][] = new SmsInfo();
...
//                case 9:
//                case 11:
//                    $this->values[$index] = new PBString();
//                    break;
//                case 7:
//                    $this->values[$index] = new PushInfo();
//                    break;
//                case 8:
//                    $this->values[$index] = new ActionChain();
//                    break;
//                case 10:
//                    $this->values[$index] = new PBInt();
//                    break;
//                case 12:
//                    $this->values[$index] = new SmsInfo();
//
//            }
//            print_r([$this->fields, $index, $this->fields[$index], $value]);

            $className = "App\GETUI_PHP_SDK\protobuf\\type\\" . $this->fields[$index];
            print_r($className);

            $this->values[$index] = new $className();
