...
class Client
{
    ...
    protected $_options = array(
        ...
        'username' => 'mark9527', // the username required by your broker
        'password' => 'dbfe8d40baa7374d54596ea513d8da96', // the password required by your broker
        ...
        'ssl' => true, // ssl context, see https://wiki.swoole.com/wiki/page/p-client_setting.html
        'debug' => false, // debug
        'socket_buffer_size' => 1024 * 1024 * 2, // 2M缓存区
        'package_max_length' => 2000000, // 协议最大长度
        'client_id' => 'MqttClient_Mark'
    );
    ...
    public function __construct(string $host, int $port, $options = array())
    {
        ...
        $this->_connection = new Swoole\Async\Client(SWOOLE_SOCK_TCP, SWOOLE_SOCK_ASYNC);
    ...
    public function subscribe($topic, $options = array(), $callback = null)
    {
        ...
        if ($this->_options['debug']) {
            ...
            Log::getInstance()->info("↑ Send SUBSCRIBE package, topic:" . implode(',', array_keys($topics)) . " message_id:{$package['message_id']}", PHP_EOL);
        }
        $this->sendPackage($package);
